...
// $PHPTHUMB_CONFIG['document_root'] = $PHPTHUMB_CONFIG['document_root'].'/gallery/';
...
$PHPTHUMB_CONFIG['cache_prefix'] = 'cache_'.(isset($_SERVER['SERVER_NAME']) ? str_replace('www.', '', $_SERVER['SERVER_NAME']).'_' : ''); // keep cache file separate by domain
...
$PHPTHUMB_CONFIG['error_image_width']           = 50;      // default width for error images
$PHPTHUMB_CONFIG['error_image_height']          = 50;      // default height for error images
...
//$PHPTHUMB_CONFIG['error_bgcolor']               = 'FF'; // background color of error message images
$PHPTHUMB_CONFIG['error_textcolor']             = 'CCCCFF'; // color of text in error messages
